...
from RichBossMultiDepotv3 import RichBoss as MDRichBoss,assignmentObjective as assignObj,assignmentAvgObjective as assignAvgObj
...
total_candidate_locations_size , FH_count_for_set_up, FH_generation_population_size, FH_steady_parent_count = 10,5,20,2
...
objective = MDRichBoss(costn, vehicle_num_in_depot, demands, capacity, sacObj, problem.coordinate_points,reservedDList,totalDistObj)
