...
objective = MDRichBoss(costn, vehicle_num_in_depot, demands, capacity, sacObj, problem.coordinate_points,reservedDList)
...
objective.printPlotSolution(problem.coordinate_points, best_routes,best_List)
