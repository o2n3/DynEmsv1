...
if __name__ == '__main__':
    ...
    capacity = 999999
    vehicle_num_in_depot = 3
    sacObj = routeTotal#nodeTotal#routeTotal #nodeTotal #routeTotal # routeTotal  #nodeTotal #routeTotal #nodeTotal #routeTotal # depotTotal #nodeTotal
    reservedDList = [0,11] #[32,35,39,  13,15,12,    30,25,23,   5,4,9,  40,46,52,  60,54,59,   72,66,63,   80,71,81,   82,85,90,  98,100,92]
    rich = MDRichBoss(costn, vehicle_num_in_depot, demands, capacity, sacObj, problem.coordinate_points,reservedDList)
    
    #a=rich.mergeRoutes([0,7,0],1,1,[0,5,6,0],1,2)
    #a=rich.mergeRoutes([0,6,5,0],1,2,[0,7,0],1,1)
    #print("a:",a)
    b=0
    #a = rich.value([0, 5])
    #print("a1:",a)
    #d = [35, 13, 25, 23, 60, 59, 63, 71, 90, 100]
    d = [0,1] #, 3, 6, 9, 12, 15, 18, 21, 24, 27]
    #d = [1, 3, 7, 10, 17, 19, 20, 23, 25, 28]
