...
from RichBossMultiDepotv3 import RichBoss as MDRichBoss,assignmentObjective as assignObj, assignmentAvgObjective as assignAvgObj,assignmentObjective2 as assignObj2
...
if __name__ == '__main__':
    ...
    reserved = []
    rich = MDRichBoss(costn, route_num, demands, capacity, sacObj, problem.coordinate_points,reserved,totalDistObj)
